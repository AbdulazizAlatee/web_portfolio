...
import saeedImage from "../../assets/images/azizc.png";
import saeedImageW20 from "../../assets/images/azizc_w20.png";
import "./Hero.css";
      ...
      <Grid container>
        ...
        <Grid item md={8} sm={7} xs={12}>
          <div>
            ...
            <a
              href="https://drive.google.com/file/d/1Y_89HwoSGHgJuZj8qOEO09PTmpUdTkzp/view?usp=sharing"
              target="_blank"
              rel="noreferrer"
            >
              <Button
            ...
            <Typography sx={{ mb: 4 }} variant="body1" gutterBottom>
              {t("followMe")}
              <a
                href="https://www.linkedin.com/in/abdulazizalatee"
                target="_blank"
